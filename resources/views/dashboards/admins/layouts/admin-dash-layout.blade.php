    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-compact nav-child-indent nav-collapse-hide-child nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.ekle')}}" class="nav-link {{ (request()->is('admin/ekle*')) ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.urunler')}}" class="nav-link {{ (request()->is('admin/urunler*')) ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.firmalar')}}" class="nav-link {{ (request()->is('admin/firmalar*')) ? 'active' : '' }}">
              <i class="nav-icon fas fa-table"></i>
              <p>
              Firmalar
              </p>
          ...
          <li class="nav-item">
            <a href="{{ route('admin.importform')}}" class="nav-link {{ (request()->is('admin/importform*')) ? 'active' : '' }}">
              <i class="nav-icon fas fa-cog"></i>
              <p>
               İmport
              </p>
