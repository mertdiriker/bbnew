                ...
                <div class="card-body">
                  <div class="tab-content">
                    <div class="active tab-pane" id="duzenle">
                      <form class="form-horizontal" method="POST" action="{{ route('clientTeklifHizli') }}" id="teklifduzenleuserForm" enctype="multipart/form-data">
                             <input type="hidden" value="Yineleyerek" name="tekliftip">
                      @csrf <!-- {{ csrf_field() }} -->
                      <input type="hidden" name="teklifID" value="@foreach ($teklifs as $teklif) {{ $teklif->teklif_ID }} @endforeach">
                       ...
                       <select name="firma" id="firma" class="form-control">
                        ...
                        <br>
              <br>
              <button type="submit" class="btn btn-success">Teklifi Yinele</button>&emsp;&emsp;&emsp;
                      </div></div>
