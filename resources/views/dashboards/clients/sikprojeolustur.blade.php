          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Sık Teklif</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <div class="active tab-pane" id="duzenle">
                      ...
                      @csrf <!-- {{ csrf_field() }} -->
                    <input type="hidden" value="Sık" name="tekliftip">
                       ...
                       <select name="firma" id="firma" class="form-control">
                        ...
                        <div class="form-group row" >
                          ...
                          @if($singleorcombine=="Single")
                          <div class="col-sm-10" id="hammadde2div" style="display:none">
                        ...
                        <div class="form-group row" style="display:none">
                          ...
                          <div class="col-sm-10" >
                           <select name="singleorcombine" id="singleorcombine" class="form-control">
                               <option value="{{ $singleorcombine }}">{{ $singleorcombine }}</option>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                           <select name="pakettip" id="pakettip" class="form-control" onchange="figur1()">
                               <option value="{{ $pakettip }}"> {{ $pakettip }}</option>
