...
@section('content')
<form class="form-horizontal" method="POST" action="{{ route('clientAddTeklif') }}" id="teklifform" enctype="multipart/form-data">
	@csrf
...
<tr height=800>
	<td width="500" valign=top>
        ...
        <div class="card-header">
			...
			<select name="Product1" class="custom-select form-control-border"  id="Product1" onchange="Product1Onchange();" required>
        ...
        <div class="card-header">
			...
			<div id="DivProducthWidth2">
				 ...
				 <option value="119">Select Product</option>
                 @foreach ($products as $product)
				<option value="{{ $product->urun_ID }}">{{ $product->urun_Ad }}</option>
                @endforeach
...
<div class="form-group row">
						  ...
						  <input type="file" name="file" class="form-control" style="width:250px;" required>
						  <br>
