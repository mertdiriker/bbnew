                ...
                <div class="card-body">
                  <div class="tab-content">
                    <div class="active tab-pane" id="urun_ekle">
                      <form class="form-horizontal" method="POST" action="{{ route('userAddProduct') }}" id="urunekleuserForm">
                      @csrf <!-- {{ csrf_field() }} -->
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                          <select name="urunOlcut" class="form-control" id="urunOlcut">
                            <option value="m2">m2</option>
                            <option value="m2">adet</option>
                            <option value="m2">roll</option>
                            <option value="m2">kilo</option>
                            <option value="m2">metre</option>
                            <option value="m2">set</option>
                            <option value="m2">roll</option>
                          </select>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                          <select name="urunTur" class="form-control" id="urunTur">
                    ...
                    <!-- /.tab-pane -->
                      ...
                      <div class="tab-pane" id="firma_ekle">
                        <form class="form-horizontal" action="{{route('userAddFirm')}}" method="POST" id="firmaekleuserForm">
                        @csrf <!-- {{ csrf_field() }} -->
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="firmayetkili" placeholder="Firma Yetkili" name="firmayetkili" required>
                              <span class="text-danger error-text cnewpassword_error"></span>
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="firmailetisim" placeholder="Firma İletisim" name="firmailetisim" required>
                              <span class="text-danger error-text cnewpassword_error"></span>
                            </div>
                          </div>
                          <div class="form-group row">
