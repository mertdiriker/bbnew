                    ...
                    <div class="active tab-pane" id="duzenle">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" value="@foreach ($projects as $project) {{ $project->proje_adet }} @endforeach" onchange="pofiyat()" name="adet" >
                            <span class="text-danger error-text favoritecolor_error"></span>
                          </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="float" class="form-control" id="faturafiyattoplam" value="@foreach($projects as $project){{$project->proje_toplamfiyat}}@endforeach" name="faturafiyattoplam" >
                            <span class="text-danger error-text favoritecolor_error"></span>
                          </div>
                        </div>
