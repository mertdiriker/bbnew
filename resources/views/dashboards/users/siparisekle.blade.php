...
<div class="card-body">
                      ...
                      <form class="form-horizontal" method="POST" action="{{ route('userSiparisOlustur') }}">
                      @csrf <!-- {{ csrf_field() }} -->
                      <div class="form-group row">
                          <label for="inputEmail" class="col-sm-2 col-form-label">Sipariş No</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="spno" placeholder="SP NO" value="{{'SP'.\Carbon\Carbon::now()->format('Ymd').rand(1,99)}}" name="spno" required>
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                         <select name="firm" id="firm" class="form-control" required>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                          <select name="sevkiyat" class="form-control" id="sevkiyat" required>
